{-
 - Game types and constants definition
 -}

module Game.Defs where

-- |Sprite constants
--
data SpriteNum = SPR_DEMO
               | SPR_DEATHCAM
               -- Static sprites
               ...
               -- SPEAR: SPR_STAT_48,SPR_STAT_49,SPR_ST AT_50,SPR_STAT_51,
               -- guard
               ...
               -- SPEAR: ghosts
               -- SPEAR: SPR_BLINKY_W1,SPR_BLINKY_W2,SPR_PINKY_W1,SPR_PINKY_W2,
               -- SPEAR: SPR_CLYDE_W1,SPR_CLYDE_W2,SPR_INKY_W1,SPR_INKY_W2,
               -- SPEAR: hans
               -- SPEAR: SPR_BOSS_W1,SPR_BOSS_W2,SPR_BOSS_W3,SPR_BOSS_W4,
               -- SPEAR: SPR_BOSS_SHOOT1,SPR_BOSS_SHOOT2,SPR_BOSS_SHOOT3,SPR_BOSS_DEAD,
               -- SPEAR: SPR_BOSS_DIE1,SPR_BOSS_DIE2,SPR_BOSS_DIE3,
               -- SPEAR: schabbs
               -- SPEAR: SPR_SCHABB_W1,SPR_SCHABB_W2,SPR_SCHABB_W3,SPR_SCHABB_W4,
               -- SPEAR: SPR_SCHABB_SHOOT1,SPR_SCHABB_SHOOT2,
               -- SPEAR: SPR_SCHABB_DIE1,SPR_SCHABB_DIE2,SPR_SCHABB_DIE3,SPR_SCHABB_DEAD,
               -- SPEAR: SPR_HYPO1,SPR_HYPO2,SPR_HYPO3,SPR_HYPO4,
               -- SPEAR: fake
               -- SPEAR: SPR_FAKE_W1,SPR_FAKE_W2,SPR_FAKE_W3,SPR_FAKE_W4,
               -- SPEAR: SPR_FAKE_SHOOT,SPR_FIRE1,SPR_FIRE2,
               -- SPEAR: SPR_FAKE_DIE1,SPR_FAKE_DIE2,SPR_FAKE_DIE3,SPR_FAKE_DIE4,
               -- SPEAR: SPR_FAKE_DIE5,SPR_FAKE_DEAD,
               -- SPEAR: hitler
               -- SPEAR: SPR_MECHA_W1,SPR_MECHA_W2,SPR_MECHA_W3,SPR_MECHA_W4,
               -- SPEAR: SPR_MECHA_SHOOT1,SPR_MECHA_SHOOT2,SPR_MECHA_SHOOT3,SPR_MECHA_DEAD,
               -- SPEAR: SPR_MECHA_DIE1,SPR_MECHA_DIE2,SPR_MECHA_DIE3,
               -- SPEAR: SPR_HITLER_W1,SPR_HITLER_W2,SPR_HITLER_W3,SPR_HITLER_W4,
               -- SPEAR: SPR_HITLER_SHOOT1,SPR_HITLER_SHOOT2,SPR_HITLER_SHOOT3,SPR_HITLER_DEAD,
               -- SPEAR: SPR_HITLER_DIE1,SPR_HITLER_DIE2,SPR_HITLER_DIE3,SPR_HITLER_DIE4,
               -- SPEAR: SPR_HITLER_DIE5,SPR_HITLER_DIE6,SPR_HITLER_DIE7,
               -- SPEAR: giftmacher
               -- SPEAR: SPR_GIFT_W1,SPR_GIFT_W2,SPR_GIFT_W3,SPR_GIFT_W4,
               -- SPEAR: SPR_GIFT_SHOOT1,SPR_GIFT_SHOOT2,
               -- SPEAR: SPR_GIFT_DIE1,SPR_GIFT_DIE2,SPR_GIFT_DIE3,SPR_GIFT_DEAD,
               ...
               -- SPEAR: Angel of Death's DeathSparks(tm)
               -- SPEAR: SPR_HROCKET_1,SPR_HROCKET_2,SPR_HROCKET_3,SPR_HROCKET_4,
               -- SPEAR: SPR_HROCKET_5,SPR_HROCKET_6,SPR_HROCKET_7,SPR_HROCKET_8,
               -- SPEAR: SPR_HSMOKE_1,SPR_HSMOKE_2,SPR_HSMOKE_3,SPR_HSMOKE_4,
               -- SPEAR: SPR_HBOOM_1,SPR_HBOOM_2,SPR_HBOOM_3,
               -- SPEAR: SPR_SPARK1,SPR_SPARK2,SPR_SPARK3,SPR_SPARK4,
               -- not SPEAR
               -- gretel
               ...
               -- SPEAR: Trans Grosse
               -- SPEAR: SPR_TRANS_W1,SPR_TRANS_W2,SPR_TRANS_W3,SPR_TRANS_W4,
               -- SPEAR: SPR_TRANS_SHOOT1,SPR_TRANS_SHOOT2,SPR_TRANS_SHOOT3,SPR_TRANS_DEAD,
               -- SPEAR: SPR_TRANS_DIE1,SPR_TRANS_DIE2,SPR_TRANS_DIE3,
               -- SPEAR: Wilhelm
               -- SPEAR: SPR_WILL_W1,SPR_WILL_W2,SPR_WILL_W3,SPR_WILL_W4,
               -- SPEAR: SPR_WILL_SHOOT1,SPR_WILL_SHOOT2,SPR_WILL_SHOOT3,SPR_WILL_SHOOT4,
               -- SPEAR: SPR_WILL_DIE1,SPR_WILL_DIE2,SPR_WILL_DIE3,SPR_WILL_DEAD,
               -- SPEAR: UberMutant
               -- SPEAR: SPR_UBER_W1,SPR_UBER_W2,SPR_UBER_W3,SPR_UBER_W4,
               -- SPEAR: SPR_UBER_SHOOT1,SPR_UBER_SHOOT2,SPR_UBER_SHOOT3,SPR_UBER_SHOOT4,
               -- SPEAR: SPR_UBER_DIE1,SPR_UBER_DIE2,SPR_UBER_DIE3,SPR_UBER_DIE4,
               -- SPEAR: SPR_UBER_DEAD,
               -- SPEAR: Death Knight
               -- SPEAR: SPR_DEATH_W1,SPR_DEATH_W2,SPR_DEATH_W3,SPR_DEATH_W4,
               -- SPEAR: SPR_DEATH_SHOOT1,SPR_DEATH_SHOOT2,SPR_DEATH_SHOOT3,SPR_DEATH_SHOOT4,
               -- SPEAR: SPR_DEATH_DIE1,SPR_DEATH_DIE2,SPR_DEATH_DIE3,SPR_DEATH_DIE4,
               -- SPEAR: SPR_DEATH_DIE5,SPR_DEATH_DIE6,SPR_DEATH_DEAD,
               -- SPEAR: Ghost
               -- SPEAR: SPR_SPECTRE_W1,SPR_SPECTRE_W2,SPR_SPECTRE_W3,SPR_SPECTRE_W4,
               -- SPEAR: SPR_SPECTRE_F1,SPR_SPECTRE_F2,SPR_SPECTRE_F3,SPR_SPECTRE_F4,
               -- SPEAR: Angel of Death
               -- SPEAR: SPR_ANGEL_W1,SPR_ANGEL_W2,SPR_ANGEL_W3,SPR_ANGEL_W4,
               -- SPEAR: SPR_ANGEL_SHOOT1,SPR_ANGEL_SHOOT2,SPR_ANGEL_TIRED1,SPR_ANGEL_TIRED2,
               -- SPEAR: SPR_ANGEL_DIE1,SPR_ANGEL_DIE2,SPR_ANGEL_DIE3,SPR_ANGEL_DIE4,
               -- SPEAR: SPR_ANGEL_DIE5,SPR_ANGEL_DIE6,SPR_ANGEL_DIE7,SPR_ANGEL_DEAD,
